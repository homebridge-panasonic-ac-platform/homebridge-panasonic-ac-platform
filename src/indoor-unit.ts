  ...
  async refreshDeviceStatus() {
    ...
    try {
      ...
      if (this.exposeInsideTemp && this.deviceStatus.insideTemperature < 126) {
        ...
        this.exposeInsideTemp.updateCharacteristic(this.platform.Characteristic.TargetTemperature, this.deviceStatus.insideTemperature);
      }
      ...
      if (this.exposeOutdoorTemp && this.deviceStatus.outTemperature < 126) {
        ...
        this.exposeOutdoorTemp.updateCharacteristic(this.platform.Characteristic.TargetTemperature, this.deviceStatus.outTemperature);
      }
