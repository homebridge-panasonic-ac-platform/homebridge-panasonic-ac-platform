...
- Check new API: [intercept-traffic.md](https://github.com/homebridge-panasonic-ac-platform/homebridge-panasonic-ac-platform/blob/master/docs/intercept-traffic.md).
